...
from .views import view_event, attend_event, interested_event, decline_event
...
urlpatterns = [
    ...
    url(r'^event/interested/(?P<event_id>\d+)/$',
        interested_event, name="interested"),
    url(r'^event/decline/(?P<event_id>\d+)/$', decline_event, name="decline"),
